...
.method private processCategories(Lorg/json/JSONArray;)V
    ...
    .line 217
    .local v14, nameTimestampMap:Ljava/util/HashMap;,"Ljava/util/HashMap<Ljava/lang/String;Ljava/lang/Long;>;"
    const/4 v2, 0x2
    ...
    iget-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mDatabase:Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mCategoriesToUpdate:Ljava/util/ArrayList;
    ...
    .line 242
    new-instance v2, Lcom/android/mms/data/FestivalSmsUpdater$JSONContentException;

    const/4 v3, 0x0

    invoke-direct {v2, v3}, Lcom/android/mms/data/FestivalSmsUpdater$JSONContentException;-><init>(Lcom/android/mms/data/FestivalSmsUpdater$1;)V
    ...
    .line 249
    .local v17, oldTimestamp:Ljava/lang/Long;
    if-eqz v17, :cond_4
    ...
    iget-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mCategoriesToUpdate:Ljava/util/ArrayList;
    ...
    .end local v17           #oldTimestamp:Ljava/lang/Long;
    .end local v18           #timestamp:J
    ...
    iput-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mCategoriesToRemove:Ljava/util/Set;
...
.method private processFestivalInfo(Lorg/json/JSONObject;)V
    ...
    .line 312
    .local v10, banner:Ljava/lang/String;
    if-nez v10, :cond_0
    ...
    .line 320
    .local v14, beginString:Ljava/lang/String;
    if-nez v14, :cond_2
    ...
    .line 324
    .local v19, endString:Ljava/lang/String;
    if-nez v19, :cond_3
    ...
    .line 330
    .local v20, formatter:Ljava/text/DateFormat;
    :try_start_0
    move-object/from16 v0, v20
    ...
    .line 357
    :cond_5
    invoke-static {v10}, Lcom/android/mms/data/FestivalSmsUpdater;->completeUrl(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    move-object/from16 v0, p0

    invoke-direct {v0, v2}, Lcom/android/mms/data/FestivalSmsUpdater;->httpGetByteArray(Ljava/lang/String;)[B

    move-result-object v11

    .line 358
    .local v11, bannerByteArray:[B
    if-nez v11, :cond_6
    ...
    .line 353
    .end local v11           #bannerByteArray:[B
    :catchall_0
    move-exception v2
    ...
    .line 362
    .restart local v11       #bannerByteArray:[B
    :cond_6
    ...
    iput-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mFestivalInfoToUpdate:Landroid/content/ContentValues;

    .line 363
    move-object/from16 v0, p0

    iget-object v2, v0, Lcom/android/mms/data/FestivalSmsUpdater;->mFestivalInfoToUpdate:Landroid/content/ContentValues;

    const-string v3, "banner"

    invoke-virtual {v2, v3, v11}, Landroid/content/ContentValues;->put(Ljava/lang/String;[B)V
...
.method private updateFestivalInfo(Lcom/android/mms/data/FestivalSmsUpdater$UpdateInfo;)V
    ...
    iget-object v2, p0, Lcom/android/mms/data/FestivalSmsUpdater;->mFestivalInfoToUpdate:Landroid/content/ContentValues;
